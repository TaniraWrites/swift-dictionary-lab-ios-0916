 ...
 */
 //statesAndCapitals : [ String: String]
 ...
 */
var capital = statesAndCapitals["Tallahassee"]
 ...
 */
var anotherCapital = statesAndCapitals["Harrisburg"]
...
statesAndCapitals["Harrisburg"] = "Harrisburg"
 ...
 */
statesAndCapitals["Harrisburg"] = nil
...
if let capitalOfNy = statesAndCapitals["New York"] {
    print("The capital of \(state) is \(capitalOfNy)")
} else {
 ...
 */
var popularBands : [String:String] = [
    "Nirvana" : "Kurt Cobain, Krist Novoselic, Dave Grohl",
    "The Beatles" : "John Lennon, George Harrison, Paul McCartney, Ringo Starr",
    "The Breeders" : "Kim Deal, Kelley Deal, Josephine Wiggs, Jim Macpherson",
    "Pixies" : "Frank Black, Joey Santiago, Kim Deal, David Lovering"
...
if let pixieMembers = popularBands["Pixies"]{
    print("The members of \(bandName) consist of \(pixieMembers)")
